...
![1](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/1.png)

![2](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/2.png)

解决方案：

```
使用JSON序列化的时候，使用自定义的序列化机制，而不是默认的序列化机制，使其使用我们自定义序列化机制
```
...
![3](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/3.png)
...
![4](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/4.png)

# 1. 品牌统计

![5](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/5.png)

用户搜索的时候，除了使用分类搜索外，还有可能使用品牌搜索，所以我们还需要显示品牌数据和规格数据，品牌数据和规格数据的显示比较容易，都可以考虑使用分类统计的方式进行分组实现。

```
思路：
	使用ES的分组查询 进行获取品牌的列表数据
请求：/search  POST
参数：map={"keywords":"华为"}
返回值：map={"rows":[{},{}],total:177,totalPages:78,categoryList:["笔记本","电视"],brandList:["a","b"]}

逻辑：
	1.添加一个查询条件 分组查询  品牌的分组
	2.获取分组的结果 品牌的分组结果
```
...
![6](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/6.png)
...
![7](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/7.png)

![8](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/8.png)
...
![9](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/9.png)
...
2.后台将数据进行解析 成一个Map<String,Set<String>> 返回给前端
3.前端循环遍历即可
...
![10](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/10.png)
...
![11](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/11.png)
...
![12](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/12.png)

封装调用分组结果的方法:

![13](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/13.png)
...
![14](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/14.png)

# 3. 条件筛选

![15](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/15.png)
...
```
思路：
点击商品分类的时候 发送请求 传递给后台
后台接收请求之后，执行过滤查询 返回给前端

请求：/search  POST
参数：map={"keywords":"华为","category":"你点击的分类的值"}
返回值：map={"rows":[{},{}],total:177,totalPages:78,categoryList:["笔记本","电视"],brandList:["a","b"],"specMap":{}}
```
...
```
思路：
点击商品品牌的时候 发送请求 传递给后台
后台接收请求之后，执行过滤查询 返回给前端

请求：/search  POST
参数：map={"keywords":"华为","category":"你点击的分类的值","brand":"你点击到的品牌的值"}
返回值：map={"rows":[{},{}],total:177,totalPages:78,categoryList:["笔记本","电视"],brandList:["a","b"],"specMap":{}}
```
...
![16](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/16.png)
...
![17](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/17.png)
...
![18](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/18.png)
...
![19](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/19.png)
...
```
思路：
点击商品规格的的时候 发送请求 传递给后台
后台接收请求之后，执行过滤查询 返回给前端

请求：/search  POST
参数：map={"keywords":"华为","category":"你点击的分类的值","brand":"你点击到的品牌的值","spec_网络制式":"电信2G"}
返回值：map={"rows":[{},{}],total:177,totalPages:78,categoryList:["笔记本","电视"],brandList:["a","b"],"specMap":{}}
```
...
![20](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/20.png)
...
![21](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/21.png)
...
```
思路：
点击商品价格区间的时候 发送请求将价格区间作为字符串 传递给后台
后台接收请求之后，执行过滤查询 返回给前端

请求：/search  POST
参数：map={"keywords":"华为","category":"你点击的分类的值","brand":"你点击到的品牌的值","spec_网络制式":"电信2G","price":"0-500"}
返回值：map={"rows":[{},{}],total:177,totalPages:78,categoryList:["笔记本","电视"],brandList:["a","b"],"specMap":{}}
```
...
![22](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/22.png)
...
![23](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/23.png)
...
![24](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/24.png)
...
![25](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/25.png)
...
![26](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/26.png)

# 5. 搜索排序

## 5.1 排序分析

![27](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/27.png)
...
![28](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/28.png)
...
![29](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/29.png)

高亮显示是指根据商品关键字搜索商品的时候，显示的页面对关键字给定了特殊样式，让它显示更加突出，如上图商品搜索中，关键字编程了红色，其实就是给定了红色样式。

![30](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/30.png)
...
![31](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/31.png)
...
![32](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/32.png)
...
![33](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/33.png)
...
![34](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/34.png)
...
![35](https://raw.githubusercontent.com/Novak666/Learning-working-skill/main/畅购/2021.10.31/pics/35.png)