...
- Vue.component('组件名称',  { data:组件数据, template:组件模板内容}) 第1个参数是标签名称，第2个参数是一个选项对象
...
props名称使用注意，在props中使用驼峰形式，标签中需要使用短横线的形式字符串形式的模板中没有这个限制
...
$emit固定，后面的enlarge-text是自定义的，随便起
